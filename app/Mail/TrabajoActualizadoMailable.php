...
class TrabajoActualizadoMailable extends Mailable
{
    use Queueable, SerializesModels;
    public $subject = "Se ha actualizado la información de un trabajo asignado";
    public $contenido;
    ...
    {
        return $this->view('mails.trabajos.actualizado');
    }
}
