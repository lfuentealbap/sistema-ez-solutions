                            ...
                            <div id="carruselSeguridad" class="carousel slide " style="" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Vigile su hogar o negocio con nuestro sistema de cámaras, se los instalamos en sus puntos estratégicos</h4>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Siéntase protegido con nuestro sistema de alarmas, proteja su hogar o negocio!</h4>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Nuestras cámaras cuentan con monitoreo que puede ser instalado en su televisor!</h4>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Monitoree sus cámaras desde cualquier parte! Nuestras cámaras también pueden ser monitoreadas desde su teléfono Android o iPhone</h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="carruselInformatico" class="carousel slide" style="" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Realizamos formateo de computadores, además le instalamos el software necesario y activado para su uso</h4>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Instalamos redes de internet y telefonía para su casa o negocio para que sus equipos estén conectados.</h4>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <h4 class="text-carrusel">Nosotros realizamos servicios de rollout y mantención de equipos como computadores e impresoras a empresas.</h4>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div id="carruselElectrico" class="carousel slide" style="" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    ...
                                    <h4 class="text-carrusel">Necesita iluminar un lugar sin luz? Nosotros se lo realizamos!</h4>
                                    </div>
                                </div>
                                <div class="carousel-item">
