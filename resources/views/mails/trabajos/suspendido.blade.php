...
<body>
    ...
    border-radius: 0.25rem;">
        ...
        <span>
         ...
         <h3 style="color: rgb(255, 255, 255)"> Se ha suspendido el trabajo "{{$contenido['titulo']}}" </h3>
        </span>
        </div>
        <div class="card-body" style="flex: 1 1 auto;
        padding: 1rem 1rem;">
          <blockquote class="blockquote mb-0">
            <p>Se te ha suspendido este trabajo por el siguiente motivo:</p>
            <div> <i>{{$contenido['motivo']}}</i></div>
            <hr>
            ...
            <br><br>
            Disculpe las molestias que haya ocasionado en este incidente, ante cualquier novedad se avisará por este medio.
            <br>Se despide,
            EZ Solutions.
            <br>
